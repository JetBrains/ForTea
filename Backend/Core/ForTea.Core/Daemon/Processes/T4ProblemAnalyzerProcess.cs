...
namespace GammaJul.ForTea.Core.Daemon.Processes
{
  ...
  {
    [NotNull] private IT4File File { get; }

    [NotNull] private ElementProblemAnalyzerRegistrar Registrar { get; }

    [NotNull] private IContextBoundSettingsStore Settings { get; }
    ...
    private sealed class Processor : IRecursiveElementProcessor
    {
      ...
      [NotNull] private T4ProblemAnalyzerProcess DaemonProcess { get; }

      [NotNull] private IHighlightingConsumer Consumer { get; }

...
namespace GammaJul.ForTea.Core.Psi.Modules
{
  ...
  public sealed class T4FilePsiModule : ConcurrentUserDataHolder, IT4FilePsiModule, IDisposable
  {
    ...
    [NotNull] private IT4AssemblyReferenceManager AssemblyReferenceManager { get; }

    [NotNull] private IPsiModules PsiModules { get; }

    [NotNull] private ChangeManager ChangeManager { get; }

    [NotNull] private IShellLocks ShellLocks { get; }

    [NotNull] private IPsiServices PsiServices { get; }

    [NotNull] private IProjectFile ProjectFile { get; }

    [NotNull] private string PersistentId { get; }

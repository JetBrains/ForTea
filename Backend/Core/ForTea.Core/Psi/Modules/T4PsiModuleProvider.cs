...
namespace GammaJul.ForTea.Core.Psi.Modules
{
  ...
  {
    [NotNull] private readonly Dictionary<IProjectFile, ModuleWrapper> _modules
      = new Dictionary<IProjectFile, ModuleWrapper>();
    ...
    [CanBeNull] private TargetFrameworkId PrimaryTargetFrameworkId { get; }
    ...
    private void RemoveFile([NotNull] IProjectFile projectFile, [NotNull] PsiModuleChangeBuilder changeBuilder,
      ModuleWrapper moduleWrapper)
    {

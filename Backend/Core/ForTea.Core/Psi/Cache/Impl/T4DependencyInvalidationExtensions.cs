...
namespace GammaJul.ForTea.Core.Psi.Cache.Impl
{
  public static class T4DependencyInvalidationExtensions
  {
    ...
    [NotNull] private static object OurOutdatedDependencyIndicator { get; } = new object();

    [NotNull] private static Key<object> Key { get; } = new Key<object>("T4 outdated dependency indicator");
  }
}
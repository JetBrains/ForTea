...
namespace GammaJul.ForTea.Core.TemplateProcessing.CodeCollecting
{
  ...
  {
    [NotNull] public T4CSharpCodeGenerationResult CollectedBaseClass { get; }

    [CanBeNull] public string Encoding { get; set; }

    [NotNull, ItemNotNull] private List<IT4AppendableElementDescription> MyTransformationDescriptions { get; }

    [NotNull, ItemNotNull] private List<IT4AppendableElementDescription> MyFeatureDescriptions { get; }

    [NotNull, ItemNotNull] private List<T4ParameterDescription> MyParameterDescriptions { get; }

    [NotNull, ItemNotNull] private List<T4ImportDescription> MyImportDescriptions { get; }

    [NotNull, ItemNotNull]
    public IReadOnlyList<T4ParameterDescription> ParameterDescriptions => MyParameterDescriptions;

    [NotNull, ItemNotNull] public IReadOnlyList<T4ImportDescription> ImportDescriptions => MyImportDescriptions;

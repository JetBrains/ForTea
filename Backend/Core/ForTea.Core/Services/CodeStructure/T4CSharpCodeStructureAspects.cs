...
namespace GammaJul.ForTea.Core.Services.CodeStructure
{
  ...
  internal sealed class T4CSharpCodeStructureAspects : CodeStructureDeclarationAspects
  {
    ...
    )
    {
      ...
      else if (_element.Parent is T4CSharpCodeStructureDeclaredElement structureDeclaredElement &&
               structureDeclaredElement.ChildrenWithInheritance)
    ...
    public T4CSharpCodeStructureAspects([NotNull] T4CSharpCodeStructureDeclaredElement element,

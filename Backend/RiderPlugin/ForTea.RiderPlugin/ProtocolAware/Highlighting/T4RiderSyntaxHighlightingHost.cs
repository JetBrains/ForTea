...
namespace JetBrains.ForTea.RiderPlugin.ProtocolAware.Highlighting
{
  ...
  public sealed class T4RiderSyntaxHighlightingHost
  {
    ...
    [NotNull] private T4OutputExtensionFrontendNotifier Notifier { get; }

    [NotNull] private ISolution Solution { get; }

    [NotNull] private IPsiCachesState State { get; }

    [NotNull] private IPsiFiles Files { get; }

    [NotNull] private IDocumentHost Host { get; }

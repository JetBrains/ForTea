...
namespace GammaJul.ForTea.Core.Parsing
{
	public static partial class T4TokenNodeTypes
	{
		...
		[NotNull] public static readonly T4TokenNodeType RAW_TEXT = new T4TokenNodeType("RAW_TEXT", RAW_TEXT_NODE_TYPE_INDEX, null, None);
		[NotNull] public static readonly T4TokenNodeType RAW_CODE = new T4TokenNodeType("RAW_CODE", RAW_CODE_NODE_TYPE_INDEX, null, None);
		[NotNull] public static readonly T4TokenNodeType RAW_ATTRIBUTE_VALUE = new T4TokenNodeType("RAW_ATTRIBUTE_VALUE", RAW_ATTRIBUTE_VALUE_NODE_TYPE_INDEX, null, StringLiteral);
		[NotNull] public static readonly T4TokenNodeType WHITE_SPACE = new T4TokenNodeType("WHITE_SPACE", WHITE_SPACE_NODE_TYPE_INDEX, " ", Whitespace);
		[NotNull] public static readonly T4TokenNodeType NEW_LINE = new T4TokenNodeType("NEW_LINE", NEW_LINE_NODE_TYPE_INDEX, "\n", Whitespace);
		[NotNull] public static readonly T4TokenNodeType QUOTE = new T4TokenNodeType("QUOTE", QUOTE_NODE_TYPE_INDEX, "\"", None);
		[NotNull] public static readonly T4TokenNodeType EQUAL = new T4TokenNodeType("EQUAL", EQUAL_NODE_TYPE_INDEX, "=", None);
		[NotNull] public static readonly T4TokenNodeType TOKEN = new T4TokenNodeType("TOKEN", TOKEN_NODE_TYPE_INDEX, null, Identifier);
		[NotNull] public static readonly T4TokenNodeType OUTPUT = new T4TokenNodeType("OUTPUT", OUTPUT_NODE_TYPE_INDEX, "output", Identifier);
		[NotNull] public static readonly T4TokenNodeType IMPORT = new T4TokenNodeType("IMPORT", IMPORT_NODE_TYPE_INDEX, "import", Identifier);
		[NotNull] public static readonly T4TokenNodeType INCLUDE = new T4TokenNodeType("INCLUDE", INCLUDE_NODE_TYPE_INDEX, "include", Identifier);
		[NotNull] public static readonly T4TokenNodeType TEMPLATE = new T4TokenNodeType("TEMPLATE", TEMPLATE_NODE_TYPE_INDEX, "template", Identifier);
		[NotNull] public static readonly T4TokenNodeType ASSEMBLY = new T4TokenNodeType("ASSEMBLY", ASSEMBLY_NODE_TYPE_INDEX, "assembly", Identifier);
		[NotNull] public static readonly T4TokenNodeType PARAMETER = new T4TokenNodeType("PARAMETER", PARAMETER_NODE_TYPE_INDEX, "parameter", Identifier);

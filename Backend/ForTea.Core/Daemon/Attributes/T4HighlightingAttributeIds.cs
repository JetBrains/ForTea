...
[assembly: RegisterHighlighterGroup(
	...
	DemoText =
		"<#@ <T4_DIRECTIVE>assembly</T4_DIRECTIVE> <T4_DIRECTIVE_ATTRIBUTE>name</T4_DIRECTIVE_ATTRIBUTE>=\"<T4_RAW_ATTRIBUTE_VALUE>$(</T4_RAW_ATTRIBUTE_VALUE><T4_MACRO>SolutionDir</T4_MACRO><T4_RAW_ATTRIBUTE_VALUE>)/%</T4_RAW_ATTRIBUTE_VALUE><T4_ENVIRONMENT_VARIABLE>USERNAME</T4_ENVIRONMENT_VARIABLE><T4_RAW_ATTRIBUTE_VALUE>%/Foo.dll</T4_RAW_ATTRIBUTE_VALUE>\" #>"
)]

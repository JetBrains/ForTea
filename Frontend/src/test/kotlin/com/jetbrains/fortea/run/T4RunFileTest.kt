...
//  @Test fun testThatOutputOfUnbuiltProjectCanBeReferenced() = doTest()
  ...
  // @Test fun testBasicEnvDTEFunctions() = doTest(dumpCsproj = false)
  // @Test fun testSolutionFunctions() = doTest(dumpCsproj = false)
  // @Test fun testProjectFunctions() = doTest(dumpCsproj = false)
  // @Test fun testAstFunctions() = doTest(dumpCsproj = false)
}
